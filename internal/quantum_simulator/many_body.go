...
// ManyBodyOperator returns the one-body operator from 'dim'-body Hilbert space, the one-body operator being in slot 'particle' < 'dim', given an operator from 1-body Hilbert space
